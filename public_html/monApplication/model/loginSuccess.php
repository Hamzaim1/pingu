...
<body>
  ...
  <div class="container">
  <header>
  <button action="" class="decon">Se déconecter</button>
  </header>
  <main>
    <div class="row">
      <div class="left col-lg-4">
        ...
        <h4 class="name">nom et prenom</h4>
        <p class="info">Date de naissance : 24-02-1997</p>
        <p class="info">email@alumni.univ-avignon.fr</p>
  ...
  <div class="roww">
    ...
    <div class="shadow">
      <div class="col-sm-12">
        ...
        <div class="col-sm-8">
          <h4><a href="#">'.'context::getSessionAttribute('user')[0]['nom']'.'
</a></h4>
